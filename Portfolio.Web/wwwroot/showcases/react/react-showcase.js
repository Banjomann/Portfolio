...
function App() {
	...
	const [interests, setInterests] = (0, import_react.useState)(["Data"]);
	const [contactMethod, setContactMethod] = (0, import_react.useState)("Email");
	const [notificationsEnabled, setNotificationsEnabled] = (0, import_react.useState)(true);
	const [confidence, setConfidence] = (0, import_react.useState)(72);
	...
	const [customerDetail, setCustomerDetail] = (0, import_react.useState)(null);
	const [customerDraft, setCustomerDraft] = (0, import_react.useState)(null);
	const [orders, setOrders] = (0, import_react.useState)([]);
	const [selectedOrderId, setSelectedOrderId] = (0, import_react.useState)(null);
	const [orderDetail, setOrderDetail] = (0, import_react.useState)(null);
	const [sandboxEnabled, setSandboxEnabled] = (0, import_react.useState)(false);
	const [sandboxHasChanges, setSandboxHasChanges] = (0, import_react.useState)(false);
	const [sandboxExpiresAt, setSandboxExpiresAt] = (0, import_react.useState)(null);
	const [sandboxNotice, setSandboxNotice] = (0, import_react.useState)("");
	...
	const draftIsDirty = (0, import_react.useMemo)(() => Boolean(customerDetail && customerDraft && editableCustomerFields.some(([field]) => (customerDetail[field] ?? "") !== (customerDraft[field] ?? ""))), [customerDetail, customerDraft]);
	...
	(0, import_react.useEffect)(() => {
		...
		const delay = setTimeout(async () => {
			...
			setError("");
			try {
				const response = await fetch(`${sandboxEnabled ? "/api/northwind/sandbox/customers" : "/api/northwind/customers"}?${query}`, { signal: controller.signal });
	...
	(0, import_react.useEffect)(() => {
		...
		const controller = new AbortController();
		const customerPath = sandboxEnabled ? `/api/northwind/sandbox/customers/${selectedId}` : `/api/northwind/customers/${selectedId}`;
		setDetailLoading(true);
		fetch(customerPath, { signal: controller.signal }).then((response) => {
			...
			if (requestError.name !== "AbortError") setSandboxNotice(requestError.message);
		}).finally(() => {
	...
	(0, import_react.useEffect)(() => {
		...
		fetch(`/api/northwind/customers/${selectedId}/orders`, { signal: controller.signal }).then((response) => {
			if (!response.ok) throw new Error("Customer orders could not be loaded.");
			return response.json();
		}).then((items) => {
			setOrders(items);
			setSelectedOrderId((current) => items.some((order) => order.orderId === current) ? current : items[0]?.orderId ?? null);
		}).catch((requestError) => {
			if (requestError.name !== "AbortError") setSandboxNotice(requestError.message);
		}).finally(() => {
	...
	(0, import_react.useEffect)(() => {
		...
		fetch(`/api/northwind/orders/${selectedOrderId}`, { signal: controller.signal }).then((response) => {
			if (!response.ok) throw new Error("Order details could not be loaded.");
			return response.json();
		}).then(setOrderDetail).catch((requestError) => {
			if (requestError.name !== "AbortError") setSandboxNotice(requestError.message);
		}).finally(() => {
	...
	async function saveSandboxCustomer(event) {
		event.preventDefault();
		setSandboxNotice("");
		if (!(await fetch(`/api/northwind/sandbox/customers/${selectedId}`, {
			method: "PUT",
	...
	async function resetSandbox() {
		setSandboxNotice("");
		if (!(await fetch("/api/northwind/sandbox/reset", { method: "POST" })).ok) {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Interactive UI patterns, form controls, and API-backed data binding built with accessible native controls." })
				] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "framework-badge",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						src: react_default,
						alt: ""
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "React" })]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
				className: "showcase-nav",
				"aria-label": "React showcase sections",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
					href: "#react-controls",
					children: "Control gallery"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
					href: "#react-northwind",
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "eyebrow",
							children: "Reactive UI state"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							id: "controls-heading",
							children: "Control gallery"
						})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Every value below is bound to framework state and immediately reflected in the live summary." })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
							...
							children: [
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
											...
											children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", {
													...
													children: emailIsValid ? "Used for example notifications." : "Enter a valid email address."
												})
											]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "field-pair field-span",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Seats" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
												type: "number",
												min: "1",
												max: "20",
												value: profile.seats,
												onChange: (event) => updateProfile("seats", Number(event.target.value))
											})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Start date" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
												type: "date",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Role" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
												...
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Developer" }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Designer" }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Analyst" }),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("fieldset", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("legend", { children: "Interests" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "choice-row",
									children: [
										"Data",
										"Design",
										"Automation"
									].map((interest) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
										className: "choice",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("fieldset", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("legend", { children: "Preferred contact" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "choice-row",
									children: [
										"Email",
										"Phone",
										"Chat"
									].map((method) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
										className: "choice",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
											type: "radio",
											name: "contact-method",
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "card-heading",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "Preferences and progress" })
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
										className: "switch-row",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Notifications" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: "Enable status updates" })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
											className: "switch",
											type: "checkbox",
											role: "switch",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["Confidence ", /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("strong", { children: [confidence, "%"] })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
											type: "range",
											min: "0",
											max: "100",
											value: confidence,
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "card-heading",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "Bound state" })
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "tabs",
										role: "tablist",
										"aria-label": "Profile views",
										children: ["summary", "settings"].map((tab) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											id: `profile-${tab}-tab`,
											type: "button",
											role: "tab",
											...
											onKeyDown: (event) => {
												...
												event.currentTarget.parentElement.querySelector(`#profile-${nextTab}-tab`)?.focus();
											},
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										tabIndex: "0",
										children: activeTab === "summary" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: profile.name || "Unnamed profile" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("dl", {
											className: "summary-list",
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", { children: "Role" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("dd", { children: profile.role })] }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", { children: "Seats" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("dd", { children: profile.seats })] }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", { children: "Contact" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("dd", { children: contactMethod })] }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", { children: "Interests" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("dd", { children: interests.join(", ") || "None" })] })
											]
										})] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "Current settings" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
											"Notifications are",
											" ",
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: notificationsEnabled ? "enabled" : "disabled" }),
											". The selected start date is ",
											profile.startDate,
											"."
										] })] })
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("summary", { children: "Implementation note" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Native controls preserve keyboard behavior while framework state derives this summary." })] })
								]
							})]
						})]
					}),
					notice && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						role: "status",
						"aria-live": "polite",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: notice }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "eyebrow",
									children: "Session-isolated editing"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									id: "sandbox-heading",
									children: "Editing Sandbox"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Changes use an in-memory browser-session copy. Canonical Northwind customers and every order remain read-only." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								className: "switch-row",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: sandboxEnabled ? "Enabled" : "Disabled" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: sandboxHasChanges ? "Changes made" : "Vanilla copy" })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									className: "switch",
									type: "checkbox",
									role: "switch",
									...
									onChange: (event) => {
										if (!event.target.checked && draftIsDirty) {
											setSandboxNotice("Save or discard the unsaved customer fields before leaving sandbox mode.");
											return;
										}
							...
							sandboxEnabled && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
								className: "secondary-button",
								onClick: resetSandbox,
								children: "Reset sandbox"
							}),
							sandboxEnabled && sandboxExpiresAt && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: "Session copy expires after 30 minutes without sandbox activity." }),
							sandboxNotice && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "notification",
								role: "status",
								"aria-live": "polite",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: sandboxNotice }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									type: "button",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
										"aria-label": "Northwind customers",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: columns.map(([key, label]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
											scope: "col",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
						...
						children: [
							...
							!detailLoading && customerDraft && sandboxEnabled && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
								...
								onSubmit: saveSandboxCustomer,
								children: [
									editableCustomerFields.map(([field, label]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: label }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							...
							selectedId && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										!ordersLoading && orders.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "status",
											children: "This customer has no orders."
										}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dialog", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "eyebrow",
							children: "Native dialog"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "React-controlled launch" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "This modal uses the browser dialog element for focus management and keyboard dismissal." }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							className: "primary-button",
...
var ReactShowcaseElement = class extends HTMLElement {
	connectedCallback() {
		...
		if (!mountPoint) {
			...
			styleElement.textContent = showcase_contract_default;
			mountPoint = document.createElement("div");
			mountPoint.id = "root";
			shadowRoot.append(styleElement, mountPoint);
		}
		this.reactRoot = (0, import_client.createRoot)(mountPoint);
		this.reactRoot.render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(App, {}) }));
	}
...
if (!customElements.get("react-showcase")) customElements.define("react-showcase", ReactShowcaseElement);
//#endregion
