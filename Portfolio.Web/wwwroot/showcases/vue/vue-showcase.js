	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [
				_cache[82] || (_cache[82] = createStaticVNode("<header class=\"showcase-header\"><div><span class=\"eyebrow\">Frontend Lab</span><h1>Vue showcase</h1><p> Interactive UI patterns, form controls, and API-backed data binding built with accessible native controls. </p></div><div class=\"framework-badge\" aria-label=\"Built with Vue\"><span aria-hidden=\"true\">V</span><strong>Vue</strong></div></header><nav class=\"showcase-nav\" aria-label=\"Vue showcase sections\"><a href=\"#vue-controls\">Control gallery</a><a href=\"#vue-northwind\">Northwind data binding</a></nav>", 2)),
				...
				createBaseVNode("dialog", {
					...
					_cache[79] || (_cache[79] = createBaseVNode("p", { class: "card-kicker" }, "Vue dialog", -1)),
					_cache[80] || (_cache[80] = createBaseVNode("h2", { id: "dialog-heading" }, "Keyboard-ready modal", -1)),
					_cache[81] || (_cache[81] = createBaseVNode("p", null, "Focus stays within this dialog until it is closed.", -1)),
