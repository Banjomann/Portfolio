	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [
				_cache[84] || (_cache[84] = createStaticVNode("<header class=\"showcase-header\"><div><span class=\"eyebrow\">Frontend Lab</span><h1>Vue showcase</h1><p> Interactive UI patterns and data binding implemented with Vue refs, computed state, watchers, and accessible native controls. </p></div><div class=\"framework-badge\" aria-label=\"Built with Vue\"><span aria-hidden=\"true\">V</span><strong>Vue</strong></div></header><nav class=\"showcase-nav\" aria-label=\"Vue showcase sections\"><a href=\"#vue-controls\">Control gallery</a><a href=\"#vue-northwind\">Northwind data binding</a></nav>", 2)),
				createBaseVNode("section", _hoisted_2, [
					_cache[51] || (_cache[51] = createBaseVNode("div", { class: "section-heading" }, [createBaseVNode("div", null, [createBaseVNode("span", { class: "eyebrow" }, "Refs and computed state"), createBaseVNode("h2", { id: "controls-heading" }, "Control gallery")]), createBaseVNode("p", null, " Every value below is bound through Vue and immediately reflected in the live summary. ")], -1)),
				...
				createBaseVNode("section", _hoisted_21, [
					_cache[80] || (_cache[80] = createBaseVNode("div", { class: "section-heading" }, [createBaseVNode("div", null, [createBaseVNode("span", { class: "eyebrow" }, "API-backed state"), createBaseVNode("h2", { id: "data-heading" }, "Northwind data binding")]), createBaseVNode("p", null, " Server-driven filtering, sorting, paging, and selection against the Northwind API. ")], -1)),
					...
					createBaseVNode("article", _hoisted_28, [
						createBaseVNode("div", _hoisted_29, [_cache[53] || (_cache[53] = createBaseVNode("div", null, [createBaseVNode("p", { class: "card-kicker" }, "Customer Explorer"), createBaseVNode("h3", { id: "explorer-heading" }, "Northwind customers")], -1)), createBaseVNode("p", null, toDisplayString(totalCount.value) + " Northwind records", 1)]),
						createBaseVNode("div", _hoisted_30, [createBaseVNode("label", null, [_cache[54] || (_cache[54] = createBaseVNode("span", null, "Search customers", -1)), withDirectives(createBaseVNode("input", {
					...
					createBaseVNode("article", _hoisted_66, [createBaseVNode("div", _hoisted_67, [_cache[72] || (_cache[72] = createBaseVNode("div", null, [createBaseVNode("p", { class: "card-kicker" }, "Orders and Line Items"), createBaseVNode("h3", { id: "orders-heading" }, "Customer order workspace")], -1)), orders.value.length ? (openBlock(), createElementBlock("span", _hoisted_68, toDisplayString(orders.value.length) + " orders", 1)) : createCommentVNode("", true)]), !selectedId.value ? (openBlock(), createElementBlock("p", _hoisted_69, " Select a customer to load their orders. ")) : ordersLoading.value ? (openBlock(), createElementBlock("p", _hoisted_70, " Loading customer orders… ")) : ordersError.value ? (openBlock(), createElementBlock("div", _hoisted_71, [createBaseVNode("p", null, toDisplayString(ordersError.value), 1), createBaseVNode("button", {
						...
						createBaseVNode("dl", _hoisted_84, [
							...
							createBaseVNode("div", _hoisted_85, [_cache[79] || (_cache[79] = createBaseVNode("dt", null, "Total", -1)), createBaseVNode("dd", null, toDisplayString(formatCurrency(orderDetail.value.total)), 1)])
						])
					])) : createCommentVNode("", true)])]))])
				]),
				createBaseVNode("dialog", {
					...
					_cache[81] || (_cache[81] = createBaseVNode("p", { class: "card-kicker" }, "Vue dialog", -1)),
					_cache[82] || (_cache[82] = createBaseVNode("h2", { id: "dialog-heading" }, "Keyboard-ready modal", -1)),
					_cache[83] || (_cache[83] = createBaseVNode("p", null, "Focus stays within this dialog until it is closed.", -1)),
